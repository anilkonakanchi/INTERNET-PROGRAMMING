<div class="col-12">
    <div class="row my-5 ">
        <div class="col-md-5">
            <div class="card card-outline card-black rounded-0 shadow">
        ...
        <div class="col-md-7">
            <div class="card rounded-0 card-outline card-black shadow" >
                <div class="card-body rounded-0">
                    <h2 class="text-center">About</h2>
                    <center><hr class="bg-navy border-black w-25 border-2"></center>
                    <div>
